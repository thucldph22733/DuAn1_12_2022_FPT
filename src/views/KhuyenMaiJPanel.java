...
public class KhuyenMaiJPanel extends javax.swing.JPanel {
    ...
    private void tblKhuyenMaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblKhuyenMaiMouseClicked
        ...
        txtGiamGia.setText(tblKhuyenMai.getValueAt(index, 4).toString());
        txtNBD.setDate(XDate.toDate(tblKhuyenMai.getValueAt(index, 5).toString()));
        txtNKT.setDate(XDate.toDate(tblKhuyenMai.getValueAt(index, 6).toString()));
        if (tblKhuyenMai.getValueAt(index, 7).equals("Đang hoạt động")) {
    ...
    private void txtTimKiemKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimKiemKeyReleased
        listKM = khuyenMaiService.getSearch(txtTimKiem.getText(), txtTimKiem.getText());
        fillTableKhuyenMai(listKM);
    ...
    List<SanPhamViewModel> listSP = sanPhamService.getList(0);
    ...
    private void init() {
        fillTableSanPham(sanPhamService.getList(0));
    ...
    private void fillTableKhuyenMai(List<KhuyenMaiView> listKM) {
        ...
        for (KhuyenMaiView km : listKM) {
            i++;
            tableModel.addRow(new Object[]{i, km.getMaKhuyenMai(), km.getTenKhuyenMai(), km.getTenSanPham(), km.getGiamGia(), XDate.toString(km.getNgayBatDau()),
