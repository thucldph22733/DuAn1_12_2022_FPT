...
public class HoaDonJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblHTThanhToan = new javax.swing.JLabel();
        ...
        lblHTThanhToan.setForeground(new java.awt.Color(255, 102, 102));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(lblHTThanhToan, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lblHTThanhToan, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jLabel9))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lblNgayTao, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void tblHoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHoaDonMouseClicked
        int index = tblHoaDon.getSelectedRow();
            ...
            lblHTThanhToan.setText(hd.gethTThanhToan());
    ...
    private javax.swing.JLabel lblHTThanhToan;
    ...
    private void fillTableHoaDon(List<HoaDonView> listHDV) {
        ...
        for (HoaDonView hdv : listHDV) {
            tableModel.addRow(new Object[]{i++, hdv.getMaHoaDon(), hdv.getTenNhanVien(),
      ...
      private void fillTableCTHoaDon(List<ChiTietHoaDonView> listCTHDV) {
        ...
        int i = 1;
          for (ChiTietHoaDonView ct : listCTHDV) {
              tableModel.addRow(new Object[]{i++,ct.getMaSanPham(),ct.getTenSanPham(),ct.getSoLuong(),ct.getDonGia(),ct.getGiamGia(),ct.getThanhTien()});
          }
    }
}
