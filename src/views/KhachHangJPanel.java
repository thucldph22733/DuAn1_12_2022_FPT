...
public class KhachHangJPanel extends javax.swing.JPanel {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        JOptionPane.showMessageDialog(this, khachHangService.update(txtMa.getText(), getForm()));
        clearForm();
  ...
  private final KhachHangService khachHangService = new KhachHangServiceImpl();
    ...
    private void fillTableKH(List<KhachHangView> listKH) {
        ...
        for (KhachHangView kh : listKH) {
            mol.addRow(new Object[]{i++,kh.getMaKhachHang(),kh.getTenKhachHang(),kh.getSoDienThoai(),kh.getDiaChi()});
        }
    }
